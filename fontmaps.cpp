...
void FontMap::getTerminalFont1_DIM(std::tr1::unordered_map<std::string,Vec2f*> &dim_map)
{
std::string key = "!"; 
dim_map[key] = new Vec2f(0.53333336f,1.0f); 
key = "#"; 
dim_map[key] = new Vec2f(0.8666667f,1.0f); 
key = "$"; 
dim_map[key] = new Vec2f(0.6666667f,1.1111112f); 
key = "%"; 
dim_map[key] = new Vec2f(1.1333333f,1.0f); 
key = "0"; 
dim_map[key] = new Vec2f(0.6666667f,1.0f); 
key = "1"; 
dim_map[key] = new Vec2f(0.46666667f,1.0f); 
key = "2"; 
dim_map[key] = new Vec2f(0.6666667f,1.0f); 
key = "3"; 
dim_map[key] = new Vec2f(0.6666667f,1.0f); 
...
dim_map[key] = new Vec2f(0.6666667f,1.0f); 
key = "@"; 
dim_map[key] = new Vec2f(1.4f,1.1666666f); 
key = "["; 
dim_map[key] = new Vec2f(0.46666667f,1.2222222f); 
key = "_"; 
dim_map[key] = new Vec2f(0.8666667f,0.22222222f); 
key = "a"; 
dim_map[key] = new Vec2f(0.8666667f,0.6666667f); 
key = "&"; 
dim_map[key] = new Vec2f(0.8666667f,1.0f); 
key = "'"; 
dim_map[key] = new Vec2f(0.2f,1.0f); 
key = "*"; 
dim_map[key] = new Vec2f(0.6666667f,1.1666666f); 
key = "b"; 
dim_map[key] = new Vec2f(0.8f,0.9444444f); 
key = "\\"; 
dim_map[key] = new Vec2f(0.53333336f,1.1666666f); 
key = "c"; 
dim_map[key] = new Vec2f(0.73333335f,0.6666667f); 
key = ":"; 
dim_map[key] = new Vec2f(0.26666668f,0.8333333f); 
key = ","; 
dim_map[key] = new Vec2f(0.33333334f,0.2777778f); 
key = "d"; 
dim_map[key] = new Vec2f(0.73333335f,0.9444444f); 
key = "÷"; 
dim_map[key] = new Vec2f(0.6666667f,1.0f); 
key = "."; 
dim_map[key] = new Vec2f(0.2f,0.22222222f); 
key = "e"; 
dim_map[key] = new Vec2f(0.73333335f,0.6666667f); 
key = "="; 
dim_map[key] = new Vec2f(0.6666667f,1.0f); 
key = "f"; 
dim_map[key] = new Vec2f(0.46666667f,0.9444444f); 
key = "g"; 
dim_map[key] = new Vec2f(0.73333335f,0.9444444f); 
key = ">"; 
dim_map[key] = new Vec2f(0.6666667f,1.0f); 
key = "h"; 
dim_map[key] = new Vec2f(0.6f,0.9444444f); 
key = "i"; 
dim_map[key] = new Vec2f(0.26666668f,0.9444444f); 
key = "j"; 
dim_map[key] = new Vec2f(0.33333334f,1.2222222f); 
key = "k"; 
dim_map[key] = new Vec2f(0.8f,0.9444444f); 
key = "l"; 
dim_map[key] = new Vec2f(0.26666668f,0.9444444f); 
key = "("; 
dim_map[key] = new Vec2f(0.4f,1.2222222f); 
key = "<"; 
dim_map[key] = new Vec2f(0.6666667f,1.0f); 
key = "m"; 
dim_map[key] = new Vec2f(1.0666667f,0.6666667f); 
key = "-"; 
dim_map[key] = new Vec2f(0.53333336f,0.9444444f); 
key = "n"; 
dim_map[key] = new Vec2f(0.6f,0.6666667f); 
key = "o"; 
dim_map[key] = new Vec2f(0.73333335f,0.6666667f); 
key = "p"; 
dim_map[key] = new Vec2f(0.8f,0.9444444f); 
key = "+"; 
dim_map[key] = new Vec2f(0.6f,1.1111112f); 
key = "q"; 
dim_map[key] = new Vec2f(0.73333335f,0.9444444f); 
key = "?"; 
dim_map[key] = new Vec2f(0.6666667f,1.0f); 
...
dim_map[key] = new Vec2f(0.6666667f,1.0f); 
key = "r"; 
dim_map[key] = new Vec2f(0.46666667f,0.6666667f); 
key = "]"; 
dim_map[key] = new Vec2f(0.46666667f,1.2222222f); 
key = ")"; 
dim_map[key] = new Vec2f(0.4f,1.2222222f); 
key = "s"; 
dim_map[key] = new Vec2f(0.6666667f,0.6666667f); 
key = ";"; 
dim_map[key] = new Vec2f(0.33333334f,0.8333333f); 
key = "/"; 
dim_map[key] = new Vec2f(0.53333336f,1.1666666f); 
key = "t"; 
dim_map[key] = new Vec2f(0.53333336f,0.8888889f); 
key = "u"; 
dim_map[key] = new Vec2f(0.6666667f,0.7222222f); 
key = "v"; 
dim_map[key] = new Vec2f(0.8666667f,0.7222222f); 
key = "w"; 
dim_map[key] = new Vec2f(1.0666667f,0.7222222f); 
key = "x"; 
dim_map[key] = new Vec2f(0.73333335f,0.7222222f); 
key = "y"; 
dim_map[key] = new Vec2f(0.8666667f,1.0f); 
key = "z"; 
dim_map[key] = new Vec2f(0.53333336f,0.7222222f); 
key = "ä"; 
dim_map[key] = new Vec2f(0.8666667f,1.0f); 
key = "å"; 
dim_map[key] = new Vec2f(0.8666667f,1.0555556f); 
key = "ë"; 
dim_map[key] = new Vec2f(0.8f,1.0555556f); 
key = "ö"; 
dim_map[key] = new Vec2f(0.8f,1.0f); 
}